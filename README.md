...
**[Download Ask-for-Mac-0.1.0.dmg](https://github.com/keithadler/askmac/releases/latest/download/Ask-for-Mac-0.1.0.dmg)** (macOS 14 or later, Apple Silicon and Intel; written answers need macOS 26 with Apple Intelligence)
...
2. **Read.** Those files are read on the Mac: PDF, Word, RTF, HTML, text, Markdown, CSV and Mail messages.
...
Every answer lists its sources. An answer you cannot check is not an answer.
...
- It does not read images, Numbers, Pages, Keynote or Apple Notes yet.
